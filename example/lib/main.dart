...
void main() async {
  ...
  void testMethod({String? d, String? f}) {}

  testMethod(d: 'asd', f: 'asd');
  testMethod(
    d: 'asd',
    f: 'asd',
  );
  testMethod(
      d: 'asdвфывфыв фыв фыв фыв фы вф фывфывф ыв фыв фывф ыв фыв',
      f: 'ыф вфы вфы вфы вфы вфы вфы вфы вфы вфыв фывasd');
  testMethod(
    d: 'asdвфывфыв фыв фыв фыв фы вф фывфывф ыв фыв фывф ыв фыв',
    f: 'ыф вфы вфы вфы вфы вфы вфы вфы вфы вфыв фывasd',
  );
